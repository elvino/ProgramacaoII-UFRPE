...
public class Odonto {
   private int codigoOdonto;
    ...
    public Odonto(int codigo, String nome, String espec, String cro){
        this.setCodigoOdonto(codigo);
        this.setCroOdonto(cro);
        this.setNomeOdonto(nome);
        this.setEspecialidadeOdonto(espec);
    }    
}
